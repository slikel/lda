...
public class Estimator {
	...
	public boolean init(LDACmdOption option, List<String> data, boolean save2File, Writeable out){
		this.option = option;
		this.out = out;
		...
		if (option.est){
			if (!trnModel.initNewModel(option, data))
				return false;
			trnModel.data.localDict.writeWordMap(option.dir + File.separator + option.wordMapFileName, save2File, out);
	...
	public Dictionary getDict() {
		return this.trnModel.data.localDict;
	}
}
